...
const socialLinks = [
  {
    ...
    subText: "on LinkedIn",
    icon: Linkedin,
    url: "https://www.linkedin.com/in/diky-bintang-pamungkas-86661437b/",
    color: "#0A66C2",
  ...
  },
  {
    ...
    subText: "@Diky_Bintang",
    icon: Instagram,
    url: "https://www.instagram.com/diky_bintang/",
    color: "#E4405F",
  ...
  },
  {
    name: "GitHub",
    displayName: "Github",
    subText: "@Pamungkas584",
    icon: Github,
    url: "https://github.com/Pamungkas584",
    color: "#ffffff",
