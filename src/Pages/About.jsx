        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
          <div className="space-y-6 text-center lg:text-left">
            ...
            <p 
              ...
              data-aos-duration="1500"
            >
             Saya adalah individu yang memiliki ketertarikan mendalam pada bidang Artificial Intelligence (AI). Sejak pertama kali mengenal teknologi AI pada masa SMP, saya terinspirasi oleh kemampuannya untuk merevolusi berbagai aspek kehidupan manusia. Ketertarikan tersebut berkembang menjadi motivasi kuat untuk terus belajar dan memahami lebih dalam tentang konsep, algoritma, serta penerapan AI di dunia nyata. Saya bercita-cita untuk menjadi seorang AI Engineer yang mampu mengembangkan solusi inovatif berbasis kecerdasan buatan, serta berkontribusi dalam memajukan teknologi yang bermanfaat bagi masyarakat.
            </p>
        ...
        <blockquote className="text-gray-300 text-center lg:text-left italic font-medium text-sm relative z-10 pl-6">
          "Leveraging AI as a professional tool, not a replacement."
            ...
            <div className="flex flex-col lg:flex-row items-center lg:items-start gap-4 lg:gap-4 lg:px-0 w-full">
              <a href="" className="w-full lg:w-auto">  {/* link cv */}
              <button 
                data-aos="fade-up"
                data-aos-duration="800"
